...
public class TransactionTotalSummaryController {

    private final JobLauncher jobLauncher;
    private final Job calculateTransactionTotalJob;

    /**
     * Trigger batch job for calculating transaction total
     * 
     * @param settlementDate Settlement date (format: yyyy-MM-dd), uses current date if not provided
     * @return Execution result
     */
    @PostMapping("/calculateTransactionTotal")
    public ResponseEntity<Map<String, Object>> triggerCalculateTransactionTotal(
        ...
        try {
            ...
            // Launch Job
            jobLauncher.run(calculateTransactionTotalJob, jobParameters);
